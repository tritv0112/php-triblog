<?php
    ...
    class Blog {
        ...
        public function read() {
            $sql = "SELECT * FROM $this->table WHERE f_post_status != 2 ORDER BY n_blog_post_id DESC";
        ...
        // Read 3 newest blogs
        public function read_newest_blogs() {
            $sql = "SELECT * FROM $this->table WHERE f_post_status != 2 ORDER BY n_blog_post_id DESC LIMIT 3";
        ...
        public function read_blog_by_query($query) {
            $sql = "SELECT * FROM $this->table JOIN blog_tags ON blog_tags.n_blog_post_id = $this->table.n_blog_post_id 
                    WHERE f_post_status != 2 AND (v_post_title LIKE '%$query%' OR v_tag LIKE '%$query%')";
        ...
        // Read blogs by category
        public function read_blog_by_category() {
            $sql = "SELECT * FROM $this->table WHERE f_post_status != 2 AND n_category_id = :category_id";
        ...
        public function read_home_page_placement(){
