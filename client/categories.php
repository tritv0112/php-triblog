<?php  
    ...
    $category_blog_list = $blog->read_active_blog_by_category();
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 ftco-animate">
                            <div class="blog-entry">
                                <a href="read_blog.php?id=<?php echo $category_blog_item['n_blog_post_id'] ?>" class="block-20" style="background-image: url('admin/images/upload/<?php echo $category_blog_item['v_main_image_url'] ?>');"></a>
